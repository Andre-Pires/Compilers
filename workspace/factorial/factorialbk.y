...
expressao : INT                                       { $$ = 1; }   
          ...
          | STRN                                      { $$ = 2; }
          | left_value                                { $$ = $1; }
          | IDENTIF '(' expressoes ')'                { $$ = IDsearch($1, 0, IDlevel(), 0) && (0x7); } /* fazer o search no nivel 0 para nao confundir a funcao com a variavel */
          | IDENTIF '(' ')'                           { $$ = IDsearch($1, 0, IDlevel(), 0) && (0x7); }      /* igual */
          | '(' expressao ')'                         { $$ = $2; }
